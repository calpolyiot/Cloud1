$(document).ready(function(){
   $("#dialog").dialog({
    ...
    $("#generate-code").click(function(){
       var str = "http://" + $("#project-device-master").val() + $("#sensors").val();
      $.getJSON(str, function(data){
         if($("#sensors").val() === "/light")
            alert(data.light);
         else if($("#sensors").val() === "/temperature")
    ...
    $("#add-device").click(function(){
      ...
      var sname = $("#sensor-name").val();
      
      if (name === "" || endpoint === "" || sname === "") {
         ...
         $("#project-device-master").append($('<option value="' + endpoint + '">' + endpoint + '</option>'));
         $("#project-device-master").selectmenu("refresh");
         $("#sensors").append($('<option value="' + sname + '">' + sname + '</option>'));
         $("#sensors").selectmenu("refresh");
